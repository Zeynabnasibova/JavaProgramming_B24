...
public class TestModifiesrWithInheritance extends Modifier {

//    public int A;
//
//    protected  int B;//exex modifair
    ...
    public static void main(String[] args) {
        ...
        TestModifiesrWithInheritance obj2 = new TestModifiesrWithInheritance();
