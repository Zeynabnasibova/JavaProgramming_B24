...
The highest and lowest scores are thrown out, and the remaining scores are added together. The sumAll is then multiplied by the degree of difficulty for that dive.
